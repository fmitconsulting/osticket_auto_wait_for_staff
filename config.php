...
class AutoWaitForStaffPluginConfig extends PluginConfig {
...
' 
		...
		*/
        return array(
            'indicate-not-yours_fake' => new SectionBreakField(array(
                'label' => $__('To whom should we alert garishly? (Fake)'),
                'description' => $__('Only makes sense to indicate this to Agents, setting disabled. To disable, simply disable plugin.(Fake)'),
            )),
        );
	}
}
